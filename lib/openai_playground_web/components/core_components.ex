defmodule OpenaiPlaygroundWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpenaiPlaygroundWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpenaiPlaygroundWeb.Gettext, "errors", msg, opts)
    end
  end
